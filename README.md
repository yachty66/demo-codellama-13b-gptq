...
# Banana.dev CodeLlama-13B-GPTQ starter template

This is a CodeLlama-13B-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-codellama-13b-gptq/fork) repository to your own Github account.
